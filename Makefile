...
TARGET = a.out
SOURCES = main.cpp real_number_utils.cpp io_utils.cpp square.cpp math_equation_solver.cpp
OBJECTS = $(SOURCES:.cpp=.o)
HEADERS = real_number_utils.h io_utils.h square.h math_equation_solver.h
