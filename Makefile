...
TARGET = a.out
SOURCES = main.cpp real_number_utils/real_number_utils.cpp io_utils/io_utils.cpp square/square.cpp math_equation_solver/math_equation_solver.cpp
OBJECTS = $(SOURCES:.cpp=.o)
HEADERS = real_number_utils/real_number_utils.h io_utils/io_utils.h square/square.h math_equation_solver/math_equation_solver.h
